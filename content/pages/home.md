...
by default are '`slack`' and '`sbo`' repositories is enabled. Please read the [REPOSITORIES.md](https://gitlab.com/dslackw/slpkg/blob/master/REPOSITORIES.md) file for each of the particularities.
